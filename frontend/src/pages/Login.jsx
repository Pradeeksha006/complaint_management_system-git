...
const Login = () => {
  ...
  return (
    <div className="bg-slate-50 dark:bg-[#020b06] flex min-h-screen items-center justify-center px-4 overflow-hidden py-12 transition-colors duration-300">
      ...
      {/* Login Card */}
      <div className="w-full max-w-md rounded-3xl border border-slate-200 dark:border-[#052414] bg-white dark:bg-[#03140c] p-8 shadow-xl dark:shadow-[0_0_50px_rgba(6,44,25,0.3)] transition-all duration-300 hover:border-slate-300 dark:hover:border-[#0b3a20]">
