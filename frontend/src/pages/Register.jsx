...
const Register = () => {
  ...
  return (
    <div className="premium-dark-bg flex min-h-screen items-center justify-center px-4 overflow-hidden py-12">
      ...
      {/* Register Card */}
      <div className="w-full max-w-xl rounded-3xl border border-slate-800/80 bg-slate-900/40 backdrop-blur-xl p-8 shadow-[0_0_50px_rgba(0,0,0,0.55)] transition-all duration-300 hover:border-slate-700/60">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {/* Full Name */}
            <div className="group">
              <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 transition-colors group-focus-within:text-blue-400">Full Name</label>
              <div className="relative">
                <User className="absolute left-3.5 top-3.5 h-4.5 w-4.5 text-slate-400 transition-colors group-focus-within:text-blue-450" />
                <input 
                  type="text"
                  {...register('fullName')}
              ...
              {errors.fullName && <span className="text-xs text-red-400 font-semibold mt-1.5 block">{errors.fullName.message}</span>}
            </div>

            {/* Username */}
            <div className="group">
              <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 transition-colors group-focus-within:text-blue-400">Username</label>
              <div className="relative">
                <User className="absolute left-3.5 top-3.5 h-4.5 w-4.5 text-slate-400 transition-colors group-focus-within:text-blue-450" />
                <input 
                  type="text"
              ...
              {errors.username && <span className="text-xs text-red-400 font-semibold mt-1.5 block">{errors.username.message}</span>}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {/* Email */}
            <div className="group">
              <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 transition-colors group-focus-within:text-blue-400">Email</label>
              <div className="relative">
              ...
              {errors.email && <span className="text-xs text-red-400 font-semibold mt-1.5 block">{errors.email.message}</span>}
            </div>

            {/* Phone Number */}
            <div className="group">
              <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 transition-colors group-focus-within:text-blue-400">Phone Number</label>
              <div className="relative">
                <Phone className="absolute left-3.5 top-3.5 h-4.5 w-4.5 text-slate-400 transition-colors group-focus-within:text-blue-450" />
                <input 
                  type="text"
              ...
              {errors.phoneNumber && <span className="text-xs text-red-400 font-semibold mt-1.5 block">{errors.phoneNumber.message}</span>}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {/* Password */}
            <div className="group">
              <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 transition-colors group-focus-within:text-blue-400">Password</label>
              <div className="relative">
                <Lock className="absolute left-3.5 top-3.5 h-4.5 w-4.5 text-slate-400 transition-colors group-focus-within:text-blue-450" />
                <input 
            ...
            {/* Confirm Password */}
            <div className="group">
              <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 transition-colors group-focus-within:text-blue-400">Confirm Password</label>
              <div className="relative">
                <Lock className="absolute left-3.5 top-3.5 h-4.5 w-4.5 text-slate-400 transition-colors group-focus-within:text-blue-450" />
                <input 
              ...
              {errors.confirmPassword && <span className="text-xs text-red-400 font-semibold mt-1.5 block">{errors.confirmPassword.message}</span>}
            </div>
          </div>
