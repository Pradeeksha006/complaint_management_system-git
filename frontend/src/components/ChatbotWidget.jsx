...
const ChatbotWidget = ({ isOpen, onClose }) => {
  ...
  const processBotResponse = (msg) => {
    ...
    if (text.includes('file draft') || text.includes('new draft') || text.includes('create draft') || text.includes('draft complaint')) {
      ...
      reply = 'To sign in: 1. Click the "Sign In" link. 2. Provide either your registered username or email. 3. Enter your password. You can click the eye icon inside the input field to double-check spelling. 4. Click "Sign In". For the Admin Superuser, please use the email "pradeeksha2006@gmail.com" with password "pradeeksha2006".';
